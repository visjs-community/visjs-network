...
class CanvasRenderer {
  ...
  _redraw(hidden = false) {
    if (this.allowRedraw === true) {
      ...
      if (hidden === false) {
        console.log('this from CanvasRenderer', this)
        if (
          ...
          (this.renderingActive === false || (this.renderingActive === true && this.options.hideEdgesOnRender === false)) 
        ) {
          this._drawEdges(ctx);
        }
      }
